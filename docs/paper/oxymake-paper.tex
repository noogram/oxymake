...
Because the Slurm and Ray backends need the workspace---inputs, outputs
and state database---visible to the compute nodes, neither has a
...
ten bugs found by TLC in ten AWS systems---bugs that had been missed
...
targets. Portable scientific pipelines have a documented pain:
per-tree provenance does not survive a fresh checkout or a move to a
second machine. HPC deployments on shared filesystems are \emph{not} a

...
Dagster             & asset graph (code)& data-version staleness$^{\S}$ & service      & yes \\
...
\caption{Positioning on four axes. The rebuild-decision column names
  ...
  with the data versions of its inputs and reports the result as
  staleness; it does not skip materialisation on that
  basis~\cite{dagsterVersioning}.}
\label{tab:landscape}
\end{table}

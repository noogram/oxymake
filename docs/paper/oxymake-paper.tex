...
delivered as a single Rust binary, that derives the decision from the
declared content of the workflow
...
\textbf{OxyMake}    & file rules (TOML)& content-derived key   & single Rust binary & yes (NDJSON, MCP) \\
\bottomrule
\end{tabular}

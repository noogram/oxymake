...
|---|---|---|---|---|---|
| ADR-001 | Content-Addressable Cache as Source of Truth | Accepted (default validation strategy changed to mtime by ADR-006, then to mtime+hash by the 2026-06-10 amendment of ADR-006) | ADR-006, ADR-015 | — | blake3, mtime |
| ADR-002 | TOML Workflow Format, Not a Custom DSL | Accepted | — | — | — |
...
| ADR-005 | Daemon-Free Cooperative Execution Model | Accepted | ADR-012 | — | session, sqlite |
| ADR-006 | Pluggable Cache Validation Strategies | Accepted — **amended 2026-06-10: default changed from `mtime` to `mtime+hash`** | ADR-001 | — | blake3, cache_validation, mtime |
...
*17 ADRs scanned. Regenerate after every ADR edit.*
